					#ifndef ROBOTPORTS2014_H_
#define ROBOTPORTS2014_H_
...
static const int INTAKE_MOTOR_A_PWM_PORT			= 4;
static const int INTAKE_MOTOR_B_PWM_PORT			= 9;
...
#else
static const int SHIFTER_SOLENOID_CHAN				= 1;
#endif
